...
Кроме операций, эскизами могут быть **периоды** и **целевые суммы**.
...
Лог ваших действий с объектами: операциями и конвертами. Фиксирует добавление, изменение и удаление данных с описание произошедшего. Количество записей можно не ограничивать: указать в журнале **лимит хранения истории изменений** в ноль; ограничить максимальным количеством, при этом будут удаляться наиболее ранние записи. Можно вообще не вести журнал - для этого нужно ввести в настройку отрицательное число.

Фиксируются **только ручные** изменения. Очистка базы или загрузка из CSV происходит помимо журнала.
